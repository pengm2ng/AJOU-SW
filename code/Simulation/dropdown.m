...
global btn_close UavXposition Uav2Xposition Uav3Xposition Uav4Xposition fig4;
...
%     OPERATIONMODEDropDownLabel.Text = 'OPERATION MODE';
    ...
    UAVLabel = uilabel(UAVPositionPanel);
    UAVLabel.FontSize = 16;
    UAVLabel.FontColor = [1 1 1];
    UAVLabel.Position = [9 250 190 50];
    UAVLabel.Text = 'UAV Position Information';
    ...
    UAV1ParameterPanel.Position = [9 210 190 50];
...
%     NumberofUAVDropDownLabel.HorizontalAlignment = 'right';
    ...
    UAV2ParameterPanel.Position = [205 210 190 50];
...
%     NumberofUAVDropDownLabel.HorizontalAlignment = 'right';
    ...
    UAV3ParameterPanel.Position = [9 155 190 50];
...
%     NumberofUAVDropDownLabel.HorizontalAlignment = 'right';
    ...
    UAV4ParameterPanel.Position = [205 155 190 50];
...
%     NumberofUAVDropDownLabel.HorizontalAlignment = 'right';
    ...
    UAV5ParameterPanel.Title = 'UAV #4 Position';
    UAV5ParameterPanel.FontSize = 14;
    UAV5ParameterPanel.Position = [9 100 190 50];

        Uav4Xposition = uilabel(UAV5ParameterPanel);
%     NumberofUAVDropDownLabel.HorizontalAlignment = 'right';
    Uav4Xposition.FontSize = 13;
    Uav4Xposition.FontColor = [1 1 1];
    Uav4Xposition.Position = [5 1 350 30 ];
    ...
    GSLabel = uilabel(UAVPositionPanel);
    GSLabel.FontSize = 16;
    GSLabel.FontColor = [1 1 1];
    GSLabel.Position = [9 100 190 50];
    GSLabel.Text = 'GS Position Information';
...
%     NumberofUAVDropDownLabel.HorizontalAlignment = 'right';
    ...
    InformationPanel.Title = 'Estimated Value';
...
%     NumberofUAVDropDownLabel.HorizontalAlignment = 'right';
    ...
    ARPSlabel.Position = [5 40 350 30 ];
...
%     NumberofUAVDropDownLabel.HorizontalAlignment = 'right';
    ...
    EARPSlabel.Position = [5 40 350 30 ];
...
%}
    ...
    %{
    xyzpositionPanel = uipanel(InformationPanel);
    xyzpositionPanel.Title = 'x, y, z position(km)';
    xyzpositionPanel.FontSize = 14;
    xyzpositionPanel.BackgroundColor = [0 0 0];
    xyzpositionPanel.ForegroundColor = [1 1 1];
...
function tp(source, event)
    ...
    function selectionmode(dd, value)
        retval = get(dd, 'value');
        if strcmp(retval,'Flat')
            retval1 = 1;
            set(CenterUAVParameterPanel, 'Visible', 'Off');
        elseif strcmp(retval,'3 Dimension')
            retval1 = 2;
            set(CenterUAVParameterPanel, 'Visible', 'On');
        end
