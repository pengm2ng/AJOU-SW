...
%     crel = [CRDia*cos(CAngV*time) CRDia*sin(CAngV*time) relH+randi([1 10])];       
    ...
    switch NumRel
        ...
        case 4
            ...
            relxyz_temp = [relxyz_temp ; rel(4,:) rel(3,:) crel rel(2,:) rel(1,:)];
        case 5
...
% 유저의 dop) DOP_usr -> threed_dop30.mat  threed_dop50.mat   threed_dop70.mat으로 저장
save('threed_dop30.mat','DOP_usr');
% 위치에러) Total_PositionErr -> threed_positionerr30.mat threed_positionerr50.mat threed_positionerr70.mat
save('threed_positionerr30.mat','Total_PositionErr');
% uav위치 모아 놓은 것) relxyz_temp -> threed_uav_position30.mat threed_uav_position50.mat threed_uav_position70.mat
save('threed_uav_position30.mat','relxyz_temp');
