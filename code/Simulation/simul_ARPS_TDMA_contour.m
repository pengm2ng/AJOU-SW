...
for usr_y = pos_start : pos_step : pos_end
    ...
    %% Estimate Relay Node Position
        ...
        for n = 1:NumRel
            ...
            temp_pr = genrng(1,relxyz_d(n,:),ref,refid,dtime,[1 1 0 1 0]);
            pr_rel(k) = temp_pr(k);            
            end
...
fprintf(fd, 'simul_ARPS_TDMA_contour_%02d\n', count);
fprintf('simul_ARPS_TDMA_contour_%02d is saved !!\n', count);
% file open end
